...
contract StarNotary is ERC721 {
    ...
    string public name = "Starnotoken";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(owner1 == msg.sender || owner2 == msg.sender, "You can only exchange stars that you own");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(owner == msg.sender, "You can only transfer stars you own");
